...
export const Hero = () => {
  return <section id="inicio" className="relative min-h-screen flex items-center overflow-hidden pt-20">
      {/* Gradient Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left animate-fade-in-up">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              <Button size="lg" onClick={() => window.location.href = "/auth"} className="bg-secondary hover:bg-secondary-glow text-secondary-foreground shadow-strong hover:shadow-strong hover:scale-105 transition-smooth">
                <Download className="w-5 h-5 mr-2" />
                Começar Agora
              </Button>
              <Button size="lg" variant="outline" onClick={() => document.getElementById('funcionalidades')?.scrollIntoView({
              behavior: 'smooth'
          ...
          {/* Mockup */}
          <div className="relative lg:ml-auto animate-fade-in" style={{
          animationDelay: "0.2s"
        }}>
            <div className="relative z-10 max-w-md mx-auto">
              <img alt="Fintrack App Interface" className="w-full h-auto drop-shadow-2xl animate-float" src="/lovable-uploads/8a8ac7b0-4aca-4822-bd37-d4874a5dd035.png" />
            </div>
